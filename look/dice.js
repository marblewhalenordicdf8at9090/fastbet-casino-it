...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-b0b9eb66');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-b0b9eb66');}
...
var brandEl=document.querySelector('.rl-brand-b0b9eb66');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
